...
class minimaxAI(connect4Player):
    def play(self, env, move_dict):
        ...
        best_move = self.minimax_decision(env, depth)
        move_dict['move'] = best_move
    
    def minimax_decision(self, env, depth):
    ...
    def max_value(self, env, depth, last_move, last_player):
        ...
        if self.is_terminal(env, last_move, last_player):
    ...
    def is_terminal(self, env, last_move, last_player):
    ...
    def evaluate(self, env, last_move, last_player):
        ...
        if last_move >= 0 and self.is_terminal(env, last_move, last_player):
    ...
    def check_immediate_move(self, env):
        ...
        for move in valid_moves:
            ...
            if self.is_terminal(test_env, move, self.position):
                return move
        ...
        for move in valid_moves:
            ...
            test_env.topPosition[move] -= 1
            if self.is_terminal(test_env, move, opponent):
                return move
...
class alphaBetaAI(connect4Player):
    def play(self, env, move_dict):
        ...
        depth = 4  # Balanced depth for good play within time limit
        best_move = self.alphabeta_decision(env, depth)
        move_dict['move'] = best_move
    
    def alphabeta_decision(self, env, depth):
